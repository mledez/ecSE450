...
public class Driver {
	...
	public static void main(String[] args) {
		...
		try {
			...
			SalesEmployee e3 = new SalesEmployee("Raj", "Pandy", 5489, 36.90, new int[] { 6, 9, 7, 8, 8 }, 10000,
					12250);
			d.addEmployee(e3);

			SalesEmployee e4 = new SalesEmployee("Angel", "Ramirez", 7845, 37.50, new int[] { 6, 9, 7, 8, 8 }, 12000,
					9950);
			d.addEmployee(e4);
